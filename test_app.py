...
class UserFunctionsTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.testuser = User.register_user("test", "user","test@test.com","testuser","password",None)
        self.testuser_id = 1234
        self.testuser.id = self.testuser_id
        self.u1 = User.register_user("test1","user1","test1@test.com","testuser1","password",None)
        self.u1_id = 2345
        self.u1.id = self.u1_id
        self.u2 = User.register_user("test2","user2","test2@test.com","testuser2","password",None)
        self.u2_id = 3456
        self.u2.id = self.u2_id
        self.u3 = User.register_user("test3","user3","test3@test.com","testuser3","password",None)
        self.u3_id = 4567
        self.u3.id = self.u3_id
        self.u4 = User.register_user("test4","user4","test4@test.com","testuser4","password",None)
        self.u4_id = 5678
        ...
        follow_u1.following.append(self.testuser)
        follow_u2.following.append(self.testuser)
        db.session.commit()
    ...
    def test_edit_user(self):
        ...
        with self.client as c:
            ...
            user = {"first_name": "edited_test", "last_name": "user", "email": "testuser@testuser.com", 'username': "testuser", "password": 'password', "image":None}
    ...
    def test_edit_user_not_logged_in(self):
        ...
        with self.client as c:
            ...
            self.assertEqual(res.status_code, 200)
            self.assertIn('Join to find recipes tailored to fit what will and will not be eaten in your house!', html)
    ...
    def setup_user_profile(self):
        ...
        self.p = User_profile(user_id=self.testuser.id, owner=self.testuser.username, no_foods='zucchini', 
                            yes_foods='chicken', diet_id=None, diet_name=None, intolerances='intolerances')
    ...
    def test_user_profile(self):
        ...
        with self.client as c:
            ...
            res = c.get(f"/users/profile/{self.testuser.id}", follow_redirects=True)
            html = res.get_data(as_text=True)
    ...
    def test_create_user_profile(self):
        ...
        with self.client as c:
            ...
            profile = {'user_id':3456, 'owner': 'testuser2', 'no_foods': 'apple', 'yes_foods': 'rice', 'diet_id':None,
                    'diet_name':None, 'intolerances':'soy'}
    ...
    def test_create_user_profile_not_logged_in(self):
        ...
        with self.client as c:
            ...
            res = c.post(f"/users/profile/3456", data = profile, follow_redirects=True)
            html = res.get_data(as_text=True)
    ...
    def setup_child_profile(self):
        ...
        self.cp = Child_profile(name='testchild', user_profile_id=self.p.id, user_id=self.testuser.id, no_foods='no, foods', 
                            yes_foods='yes_foods', diet_id=None, diet_name=None, intolerances='intolerances')
    ...
    def test_child_profile(self):
        ...
        with self.client as c:
            with c.session_transaction() as sess:
                sess[CURR_USER_KEY] = self.testuser_id
            res = c.get(f'/profiles/child/{self.cp.id}')
            html = res.get_data(as_text=True)
    ...
    def test_create_child_profile(self):
        ...
        with self.client as c:
            ...
            child = {'id':123, 'name':'testchild2','user_profile_id':1234, 'owner':1234, 'no_foods':'apple', 'yes_foods':'rice', 'diet_id':None,
                    'diet_name': None, 'intolerances':'soy'}
    ...
    def test_edit_child_profile(self):
        ...
        with self.client as c:
            ...
            new_child = {'name':'testchild','user_profile_id':1234, 'owner':1234, 'no_foods':'noodles', 'yes_foods':'potatoes', 'diet_id':None,
                        'diet_name':None, 'intolerances':'soy'}
    ...
    def test_delete_child_profile(self):
        ...
        self.setup_child_profile()
        cp = Child_profile.query.get_or_404(self.cp_id)
        id = cp.user_id
        ...
        with self.client as c:
            ...
            html = resp.get_data(as_text=True)
            self.assertNotIn('testchild', html)
    ...
    def test_favorite_recipe_view(self):
        ...
        with self.client as c:
            with c.session_transaction() as sess:
                sess[CURR_USER_KEY] = self.testuser_id
            res = c.get(f"/recipes/{self.fr.api_recipe_id}/favorite", follow_redirects=True)
            html = res.get_data(as_text=True)
    ...
    def test_share_recipe(self):
        ...
        share = {"recipe_name":"test", "api_recipe_id":self.fr.api_recipe_id, "user_id":self.testuser_id, 'name':self.testuser.username,
                    'follower':self.u1_id, 'message':'test'}

        with self.client as c:
            with c.session_transaction() as sess:
                sess[CURR_USER_KEY] = self.testuser_id

            res = c.post(f'/shares/{self.fr.api_recipe_id}/share-recipe', data=share, follow_redirects=True)
